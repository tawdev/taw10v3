            ...
            >
              ...
              <ul className="space-y-4 mb-10 flex-grow text-[11px] leading-relaxed relative z-10">
                {plan.features.map((feat, fIdx) => (
                  <motion.li
                    key={fIdx}
                    className={`flex items-start gap-3 transition-colors duration-300 ${feat.inactive
                  ...
                  >
                    <span className={`material-symbols-outlined text-[16px] mt-0.5 transition-colors ${feat.inactive
              ...
              <MagneticButton
                ...
                className={`w-full py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] transition-all duration-500 shadow-sm relative z-10 ${plan.popular
