              ...
              <Link 
                ...
                onClick={(e) => {
                  ...
                  if (typeof window !== 'undefined' && (window as unknown as Window & { dataLayer?: any[] }).dataLayer) {
                    (window as unknown as Window & { dataLayer: any[] }).dataLayer.push({ event: 'button_click', button_name: 'consultation', location: 'desktop_header' });
                  }
                }}
                ...
                >
                  <Link 
                    ...
                    onClick={(e) => {
                      scrollToSection(e, "#contact");
                      if (typeof window !== 'undefined' && (window as unknown as Window & { dataLayer?: any[] }).dataLayer) {
                        (window as unknown as Window & { dataLayer: any[] }).dataLayer.push({ event: 'button_click', button_name: 'consultation', location: 'mobile_header' });
                      }
                    }}
